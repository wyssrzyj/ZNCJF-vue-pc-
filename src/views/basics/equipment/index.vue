  ...
  <njp-table-config ref="styleLibListEl" :query-form-data="state.queryFormData" @on-add-update-handle="handleAddOrUpdate" @row-dblclick="handleRowDbclick">
    <template #queryFormItem>
      ...
      <el-form-item label="设备编号" prop="number">
        <el-input v-model="state.queryFormData.number" placeholder="请输入" clearable />
      </el-form-item>
    ...
    <template #operationExtBtn>
      ...
      <el-button type="primary" style="order: 3" @click="handleClick(true, '查看设备')">查看</el-button>
      <el-button type="primary" style="order: 3" @click="handleClick(false, '编辑设备')">编辑</el-button>
    </template>
