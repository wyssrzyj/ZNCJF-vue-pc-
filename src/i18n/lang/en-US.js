export default {
    ui: {
        ...
        setting: {
            ...
            tabStyles3: "card",
            //
            settingTips: "This function can preview various layout effects in real time. More complete configurations can be set in src/constants/config.ts. The configuration will be remembered after modification and can be used in a production environment.",
        ...
        order: {
            rules: {
                productId: "Required field cannot be empty",
                productName: "Required field cannot be empty",
                payAmount: "Required field cannot be empty"
            }
        },
        sysarticlescategory: {
            rules: {
                signname: "Required field cannot be empty"
            }
        },
        sysarticles: {
            rules: {
